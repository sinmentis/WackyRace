#ifndef UARTSERIAL_HPP
#define UARTSERIAL_HPP
...
namespace Wacky
{
    ...
    // This implements a stream connection with a UART.  By default
    ...
    class UartSerial : public Print
    {
    public:
        
        enum channel {UART_0, UART_1};    
        
        bool begin (channel channel=UART_0, uint32_t baud_rate=115200);
