...
#define BLUETOOTH_RESET_PIO PA11_PIO
#define BLUETOOTH_POWER_PIO PA12_PIO
#define BLUETOOTH_BAUD_PIO PA14_PIO
#define BLUETOOTH_MASTER_PIO PA13_PIO
#define BLUETOOTH_AUTO_DISCOVER_PIO PA15_PIO
...
void bluetooth_init (void)
{
    ...
    /* Set delay as appropriate for your device.  TODO.  */
    delay_ms (1);
    #endif

    pio_config_set (BLUETOOTH_BAUD_PIO, PIO_OUTPUT_LOW);
    pio_config_set (BLUETOOTH_MASTER_PIO, PIO_OUTPUT_HIGH);
    pio_config_set (BLUETOOTH_AUTO_DISCOVER_PIO, PIO_OUTPUT_HIGH);        
